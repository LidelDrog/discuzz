...
<link rel="stylesheet" href="${ctx}/static/server/layui/css/layui.css"
	media="all" />
<link rel="stylesheet" href="${ctx}/static/server/font-awesome/css/font-awesome.min.css">
<style type="text/css">
#Images li{
	float:left;
	margin-left:10px;
		...
		<div class="layui-form">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<button onclick="goBack();" class="layui-btn layui-btn-primary layui-layer-close layui-layer-close1">返回</button>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript" src="${ctx}/static/server/layui/layui.js"></script>
...
layui.use('upload', function() {
	...
	upload.render({
		url: '${ctx}/imageUpload/headerImage'
