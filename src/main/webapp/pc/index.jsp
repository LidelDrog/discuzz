...
<head>
	<meta charset="UTF-8">
	<title>兼职平台—首页</title>
	<link rel="stylesheet" type="text/css" href="${ctx}/static/pc/css/common.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/static/pc/css/index.css">
	<link rel="icon" type="image/x-icon" href="${ctx}/static/pc/images/titleLogo.png">
</head>
<body>
<div class="page">
	<div class="top">
			...
			<div class="top_zhong_ri">
				<c:if test="${pcUser == null}">
					<ul class="top_zhong_ul01">
						...
						<li><a href="${ctx}/pc/login/goLogin" class="a_deng"><span class="span_deng" align="right">登录</span></a></li>
						<li><span class="span_xian"></span><a href="${ctx}/pc/login/goRegister" class="a_zhu"><span class="span_zhu">注册</span></a></li>
					</ul>
				</c:if>
				<c:if test="${pcUser != null}">
		...
		<div class="daohang_zhong">
			<div class="daohang_logo">
				<div class="daohang_logo01">
					<a href="${ctx}/pc/index/goIndex.action" title="平台首页">
						<img src="${systemUpset.companyLogo}" width="200" height="60"></a>
				</div>
			</div>
	...
	<div class="guanggao">
		<div class="guanggao_zhong">
			...
			<div class="guanggao_zhong_x">
				<ul>
					<li><a href="https://store.meizu.com/" title="魅族官网" target="_blank"><span><img src="${ctx}/static/pc/images/meizu.png" width="170" height="102"></span></a></li>
					<li><a href="https://www.taobao.com/" title="淘宝网" target="_blank"><span><img src="${ctx}/static/pc/images/taobao.png" width="170" height="102"></span></a></li>
					<li><a href="https://www.mi.com/" title="小米官网" target="_blank"><span><img src="${ctx}/static/pc/images/xiaomi.png" width="170" height="102"></span></a></li>
					<li><a href="https://www.jd.com/" title="京东官网" target="_blank"><span><img src="${ctx}/static/pc/images/jingdong.png" width="170" height="102"></span></a></li>
					<li><a href="https://www.huawei.com/cn/" title="华为官网" target="_blank"><span><img src="${ctx}/static/pc/images/huawei.png" width="170" height="102"></span></a></li>
					<li><a href="https://www.lenovo.com.cn/" title="联想官网" target="_blank"><span><img src="${ctx}/static/pc/images/lianxiang.png" width="170" height="102"></span></a></li>
				</ul>
			</div>
		</div>
	</div>
	<jsp:include page="${ctx}/pc/index/goFooter.action" />
	
</div>
<script type="text/javascript" src="${ctx}/static/pc/js/jquery-1.11.1.min.js"></script>
