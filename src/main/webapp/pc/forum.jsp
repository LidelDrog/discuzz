...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/pc/css/forum.css">
...
<script type="text/javascript">
		...
		reader.onload=function(e){
			if(tou_str != ".jpg" && tou_str != ".png" && tou_str != ".JPG" && tou_str != ".PNG"){
				...
				if(tou_max>5194304){
					...
					$.ajax({
					      type: "post",
					      url: "${ctx}/imageUpload/forumImage",
					      data: file,
	...
	$(".input_ping").click(function(){
		...
		if('${pcUser}' == ''){
			...
			$.ajax({
                type: "POST",
                url: "${ctx}/pc/action/addForumReply",
                data: {
