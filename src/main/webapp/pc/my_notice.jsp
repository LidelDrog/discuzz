...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/pc/css/my_notice.css">
	<link rel="icon" type="image/x-icon" href="${ctx}/static/pc/images/titleLogo.png">
	
</head>
<body>
	<div class="page">
		<jsp:include page="${ctx}/pc/index/goHeader.action" />
		<div class="div_personal">
			<div class="div_zhong">
				<jsp:include page="${ctx}/pc/personal/goPersonalCommon.action" />
...
<%--	<script type="text/javascript" src="${ctx}/static/pc/js/my_notice.js"></script>--%>
	<script type="text/javascript">
		...
		for(var i=0;i<span_z_m_nums.length;i++){
			$(".ul_span_z_nei li .span_z_m:eq("+i+")").click(function(nums){
				return function(){
					$.ajax({
					   url:"${ctx}/pc/personal/deleteMyChatList",
